...
- There is one further lab session (09 Feb) before the third exercise is due.
...
````
git clone https://github.com/LangProc/langproc-2025-lab-${LOGIN}.git
````
...
````
git remote add spec https://github.com/LangProc/langproc-lab.git
````
